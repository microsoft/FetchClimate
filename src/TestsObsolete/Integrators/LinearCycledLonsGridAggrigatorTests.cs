...
namespace Microsoft.Research.Science.FetchClimate2.Tests
{
    ...
    public class LinearCycledLonsGridAggregatorTests
    {
        ...
        {
            var lclga = new LinearCycledLonsGridIntegrator(Build360Axis(), false);
        ...
        {
            var lclga = new LinearCycledLonsGridIntegrator(Build180Axis(), false);
        ...
        {
            var a = new LinearCycledLonsGridIntegrator(Build360Axis(), false);
        ...
        {
            var a = new LinearCycledLonsGridIntegrator(Build360AxisBoundariesRepeated(), true);
        ...
        {
            var a = new LinearCycledLonsGridIntegrator(Build180Axis(), false);
