...
namespace Microsoft.Research.Science.FetchClimate2.Tests.DataHandlers.VirtualVariables
{
    ...
    public class VirtualVariablesTests
    {
        ...
        public void VirtualVariablesInfrastructureTest()
        {
            ...
            VirtVarRequestContextStub contextStubA = new VirtVarRequestContextStub(requestA, double.MaxValue);
            ...
            VirtVarRequestContextStub contextStubE = new VirtVarRequestContextStub(requestE, 33.456);
            ...
            VirtVarRequestContextStub contextStubX = new VirtVarRequestContextStub(requestX, 3 + 2 * 5);
