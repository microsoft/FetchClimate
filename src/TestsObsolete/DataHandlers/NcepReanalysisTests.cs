...
namespace Microsoft.Research.Science.FetchClimate2.Tests.DataSources
{
    ...
    public class NcepReanalysisTests
    {
        ...
        public async Task CellSetDataTest()
        {
            ...
            TimeRegion tr = new TimeRegion(firstYear: 1980, lastYear: 1980, firstDay: 2, lastDay: 3, startHour: 0, stopHour: 0).
        ...
        public async Task ReanalysisAllVaraiblesValuesTest()
        {
            ...
            TimeRegion tr = new TimeRegion(firstYear: 1980, lastYear: 1980, firstDay: 1, lastDay: 1, startHour: 0, stopHour: 0); //index 46752 ; hours sice 1-1-1 00:00:00   =  17347536
            FetchDomain tmpDomain = FetchDomain.CreatePoints(
            ...
            var gaussStorage = TestDataStorageFactory.GetStorage(TestConstants.UriReanalysisGauss);
            NCEPReanalysisGaussT62GridDataHandler gaussHandler = await NCEPReanalysisGaussT62GridDataHandler.CreateAsync(gaussStorage);

            TimeRegion tr2 = new TimeRegion(firstYear: 1980, lastYear: 1980, firstDay: 1, lastDay: 1, startHour: 0, stopHour: 6); //index 46752 ; hours sice 1-1-1 00:00:00   =  17347536
            FetchDomain preDomain = FetchDomain.CreatePoints(
        ...
        public async Task Bug1335() //reanalysis returns 11.7 uncertainty for future climate instead of NAN
        {
            ...
            TimeRegion tr = new TimeRegion().GetMonthlyTimeseries().GetYearlyTimeseries(firstYear: 1951, lastYear: 2200);
        ...
        public async Task ReanslysisNewYearCrossingTest()
        {
            ...
            TimeRegion crossingTr = new TimeRegion(firstYear: 1950, lastYear: 1951, firstDay: 336, lastDay: 30);
            FetchDomain crossingDomain = FetchDomain.CreatePoints(
                new double[] { -37.5 }, // data index 51
                new double[] { 137.5 }, //data index 55
                 crossingTr);

            TimeRegion firstTr = new TimeRegion(firstYear: 1950, lastYear: 1950, firstDay: 336, lastDay: 365);
            FetchDomain firstDomain = FetchDomain.CreatePoints(
                new double[] { -37.5 }, // data index 51
                new double[] { 137.5 }, //data index 55
                 firstTr);

            TimeRegion secondTr = new TimeRegion(firstYear: 1951, lastYear: 1951, firstDay: 1, lastDay: 30);
            FetchDomain secondDomain = FetchDomain.CreatePoints(
                new double[] { -37.5 }, // data index 51
                new double[] { 137.5 }, //data index 55
                 secondTr);
            ...
            Assert.AreEqual(crossing, (first + second) / 2.0, TestConstants.DoublePrecision);
        }
        ...
        public async Task ReanslysisNewYearCrossingSubDayTest()
        {
            ...
            TimeRegion crossingTr = new TimeRegion(firstYear: 1950, lastYear: 1951, firstDay: 336, lastDay: 30, startHour: 0, stopHour: 12);
            FetchDomain crossingDomain = FetchDomain.CreatePoints(
                new double[] { -37.5 }, // data index 51
                new double[] { 137.5 }, //data index 55
                 crossingTr);

            TimeRegion firstTr = new TimeRegion(firstYear: 1950, lastYear: 1950, firstDay: 336, lastDay: 365, startHour: 0, stopHour: 12);
            FetchDomain firstDomain = FetchDomain.CreatePoints(
                new double[] { -37.5 }, // data index 51
                new double[] { 137.5 }, //data index 55
                 firstTr);

            TimeRegion secondTr = new TimeRegion(firstYear: 1951, lastYear: 1951, firstDay: 1, lastDay: 30, startHour: 0, stopHour: 12);
            FetchDomain secondDomain = FetchDomain.CreatePoints(
                new double[] { -37.5 }, // data index 51
                new double[] { 137.5 }, //data index 55
                 secondTr);
        ...
        public async Task CellGridDataLinearInterpolationTest()
        {
            ...
            TimeRegion tr = new TimeRegion(firstYear: 1980, lastYear: 1980, firstDay: 2, lastDay: 3, startHour: 0, stopHour: 0).
                GetSeasonlyTimeseries(firstDay: 2, lastDay: 3, isIntervalTimeseries: false);//indeces 46756,46760; hours sice 1-1-1 00:00:00   =  17347560 , 17347524
            FetchDomain domain = FetchDomain.CreateCellGrid(
                //ocean region
